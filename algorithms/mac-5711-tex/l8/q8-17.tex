...
\textbf{Consumo de tempo:} Como vimos, o algoritmo \proc{Dijkstra-Single-Pair} toma tempo $O(E lg V)$ e nós o chamamos apenas uma vez na linha 1. As demais linhas consomem tempo constante $\Theta(1)$. Logo, o consumo de tempo total é $O(E lg V)$.\\[6pt]